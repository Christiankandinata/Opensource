library(Lahman)
library(tidyverse)
library(broom) # library for tidy function
...
###### Quiz ######
    # regression with BB, HR in year 1971
    fit2 <- Teams %>% 
    ...
    # regression with BB, HR in 1961 to 2018
    fit3 <- Teams %>% 
...
# and batted more than 130 times (minimum to win Rookie of the Year):
